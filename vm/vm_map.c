 ...
 *	vm_map_copy_discard_cont live in rust/src/vm/vm_map_ffi.rs now.
 *	The copyin/copyout routines below still call
 *	vm_map_copy_steal_pages, whose prototype is in vm/vm_map.h.
 */
 ...
 *	internal linkage when the copy family moves in M5.
 */
void
