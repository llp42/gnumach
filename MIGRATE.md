...
`vm_map_glue_task_space` pair, `i386/i386/irq.c`'s six accessors, and
`i386/i386at/com.c`'s `com_base_addr`/`com_irq` pair are deleted; nothing
joined the list since.
