...
#define	ip_lock_init(port)	simple_lock_init(&(&(port)->ip_object)->io_lock_data)
#define	ip_lock(port)		simple_lock(&(&(port)->ip_object)->io_lock_data)
#define	ip_lock_try(port)	simple_lock_try(&(&(port)->ip_object)->io_lock_data)
#define	ip_unlock(port)		simple_unlock(&(&(port)->ip_object)->io_lock_data)
